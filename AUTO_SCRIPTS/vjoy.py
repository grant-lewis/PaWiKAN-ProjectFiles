...
def setJoy(valueX, valueY, valueZ, valueRx, valueRy, valueRz, scale):
    xPos = int(valueX*scale)
    yPos = int(valueY*scale)
    zPos = int(valueZ*scale)
    RxPos = int(valueRx*scale)
    RyPos = int(valueRy*scale)
    RzPos = int(valueRz*scale)    
    joystickPosition = vj.generateJoystickPosition(wAxisX = 16000+xPos, wAxisY = 16000+yPos, wAxisZ = 16000+zPos, wAxisXRot= 16000+RxPos, wAxisYRot = 16000+RyPos, wAxisZRot = 16000+RzPos)
